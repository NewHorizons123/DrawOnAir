...
class PatternRecognizer:
    ...
    def _set_path(self, nodes, x_index_finger, y_index_finger):
        ...
        node_0, node_1, node_2, node_3, node_4, node_5, node_6, node_7, node_8 = nodes[0], nodes[1], nodes[2], nodes[3], \
    ...
    def handle_stream(self):
        ...
        with self._mp_hands.Hands(model_complexity=0, min_detection_confidence=0.5,
            ...
            while cap.isOpened():
                ...
                if is_authorized:
                    cv2.putText(image, "Authorized", (image_width // 2 - 50, image_height // 2 - 50),
                                cv2.FONT_HERSHEY_COMPLEX, 1, (120, 110, 225), 2)
                ...
                if results.multi_hand_landmarks:
                    for hand_landmarks in results.multi_hand_landmarks:
                        ...
                        x_index_finger = int(
                            hand_landmarks.landmark[self._mp_hands.HandLandmark.INDEX_FINGER_TIP].x * image_width)
                        y_index_finger = int(
                            hand_landmarks.landmark[self._mp_hands.HandLandmark.INDEX_FINGER_TIP].y * image_height)
